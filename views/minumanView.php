...
<body>
    <div class="container">
        <div class="dashboard-header">
            ...
            <a href="?page=minumanAdd" class="add-button">
        ...
        <div class="card">
            <div class="search-wrapper">
                ...
                <input type="text" class="search-input" placeholder="Cari minuman..." id="searchInput">
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="region-badge">
                                <?= htmlspecialchars($data["daerah_minuman"]) ?>
                            </span>
                        </td>
                        <td class="center">
                            <div class="action-buttons">
                                <a href="?page=minumanUpdate&id=<?= $data['id_minuman']; ?>" class="btn btn-edit">
